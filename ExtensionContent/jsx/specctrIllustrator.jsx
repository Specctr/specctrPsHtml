...
//~         
//~         var result = false;
//~         if(myString.indexOf("|"+obj+"|")!=-1) result=true;
//~         return result;
//~ }
...
//~ this.addSpecsStyleTextToCss = function(variableId, text, specsInfo)
//~ {
//~     try
//~     {
//~         var styleText = text;
...
//~ this.getCssForPathItems = function(coordinateSpecsInfo)
//~ {
//~     try
//~     {
//~         var doc = app.activeDocument;
...
//~ this.getCssForText = function(coordinateSpecsInfo)
//~ {
//~     try
//~     {
//~         var doc = app.activeDocument;
...
//~ this.getStyleFromOtherSpecs = function(specName, styleName)
//~ {
//~     var doc = app.activeDocument;
...
//~ this.removeSpacingItemsGroup = function(idVarForFirstItem, idVarForSecondItem, groupName)
//~ {
//~      try
//~     {
...
//~ this.removeSpecGroup = function(idVar, groupName)
//~ {
//~     try
//~     {
//~         if(idVar)
...
//~ this.setUniqueIDToItem = function(pageItem)
//~ {
//~     try
//~     {
//~         var date = new Date();
...
//~     try
//~     {
//~         //Add the function to get the active art Item.
//~         //---------
//~         //--------
//~         
...
//~ this.createCoordinateSpecsForItem = function(pageItem)
//~ {
//~     try
//~     {
...
//~ this.createSpacingVerticalSpec = function(x, y1, y2, itemsGroup)
//~ {
//~     try
//~     {
...
//~ this.createSpacingHorizontalSpec = function(y, x1, x2, itemsGroup)
//~ {
//~     try
//~     {
//~         var legendLayer = this.legendSpacingLayer();
...
//~ this.createSpacingSpecsForItems = function(aItem, bItem)
//~ {			
//~     try
//~     {
//~         var legendLayer = this.legendSpacingLayer();
...
//~ this.createSpacingSpecsForItem = function(pageItem)
//~ {
//~     try
//~     {
...
//~ this.updateConnection=function(buttonInvoked)
//~ {
//~     try
//~     {
...
//~                         
//~                             dataString = this.separateNoteAndStyleText(currPageItems[i].note);
...
//~ this.createPropertySpecsForItem = function(sourceItem)
//~ {
//~     try
//~     {
//~         var spacing = 10;
...
//~ this.getBoldStyleOfFont = function()
//~ {
...
//~ this.separateNoteAndStyleText = function(dataString, separateStringValue)
//~ {
...
//~ //Returns the bounds of the object, In this function, stroke width is calculated and then added to the bounds of the object.
//~ this.itemGeometricBounds = function(textFrame)
//~ {
...
//~     try
//~     {
//~         if (textFrame.stroked)      //Add the stroke width, If stroke is applied to objects.
//~         {
...
//~ this.circleDiameter = function(strokeWidth)
//~ {
//~     return Math.max(3,strokeWidth*2+3);
//~ }

//~ this.positionChanged=function(item,savedCoords)
//~ {
//~     try{
...
//~ }
//~     
//~ this.legendColorObject=function()
//~ {
//~     var newColor = new RGBColor();
...
//~ }
//~ 		
//~ this.legendColorSpacing=function()
//~ {
//~     var newColor= new RGBColor();
...
//~ this.rChannel=function(value) {
//~ 			return value >> 16 & 0xFF;
//~ 		}
//~ 		
//~ this.gChannel=function(value) {
//~ 			return value >> 8 & 0xFF;
//~ 		}
//~ 		
//~ this.bChannel=function(value){
//~ 			return value >> 0 & 0xFF;
//~ 		}    

//~ this.pointsToUnitsString=function(value,units)
//~ {
//~     if(units==null) units=app.activeDocument.rulerUnits;
//~     
//~     var result;
//~     
//~     switch (units)
...
//~ }
//~ 		
//~ this.typeUnits=function()
//~ {
//~     if (app.activeDocument.rulerUnits==RulerUnits.Pixels) return "px"; 
//~     else return "pt";
//~ }
...
//~         
//~         case "SpotColor":
//~         result=color.spot.name+"\r"+this.colorAsString(color.spot.color)+" tint: "+Math.round(color.tint);
//~         break;
//~         
//~         case "PatternColor":
...
//~         {
//~             result+=this.colorAsString(color.gradient.gradientStops[i].color)+" alpha: "+Math.round(color.gradient.gradientStops[i].opacity)+"%\r";
//~         }
//~         break;
//~         
//~         
...
//~ this.getRoundCornerValue = function(pageItem)
//~ {
//~     try
//~     {
//~         var infoText = "";
...
//~ this.getSpecsInfoForGeneralItem = function(sourceItem)
//~ {
...
//~ this.getSpecsInfoForPathItem = function(pageItem)
//~ {
//~     var infoText = "";
...
//~ this.getSpecsInfoForTextItem = function(pageItem)
//~ {
//~     var infoText = "";
...
//~         else 
//~         {   
//~             fontSize = Math.round(attr.size * 10) / 10 + " " + this.typeUnits();
...
//~ }
//~ 		
//~ this.originalArtboardRect = function()
//~ {		
