    ...
    createCoordinates : function(sourceItem, bounds) {
        try {
            ...
            if(!model.specInPrcntg) {
                ...
                left = Math.round(1.0 * bounds[0] / relativeWidth * 10000) / 100 + "%";
                top = Math.round(1.0 * bounds[1] / relativeHeight * 10000) / 100 + "%";
                right = Math.round(1.0 * bounds[2] / relativeWidth * 10000) / 100 + "%";
                bottom = Math.round(1.0 * bounds[3] / relativeHeight * 10000) / 100 + "%";
            }
